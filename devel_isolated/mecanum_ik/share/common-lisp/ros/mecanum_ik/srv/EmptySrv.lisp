...
(cl:defmethod cl:initialize-instance :after ((m <EmptySrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EmptySrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_ik-srv:<EmptySrv-request> is deprecated: use mecanum_ik-srv:EmptySrv-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EmptySrv-request>)))
  ...
  (cl:format cl:nil "# Empty service, no request and response~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EmptySrv-request)))
  "Returns full string definition for message of type 'EmptySrv-request"
  (cl:format cl:nil "# Empty service, no request and response~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <EmptySrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EmptySrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecanum_ik-srv:<EmptySrv-response> is deprecated: use mecanum_ik-srv:EmptySrv-response instead.")))
